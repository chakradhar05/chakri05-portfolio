...
function Contact() {
  return (
    <section id="contact" className="h-auto w-full flex justify-center py-12 md:py-24">
      <div className="mt-5 px-8 flex flex-col justify-center max-w-lg w-full">
        ...
        <div className="py-10 px-4">
          <form action="https://getform.io/f/paoxvpnb" method="POST" className="flex flex-col">
            <div className="mb-5">
              <label
                htmlFor="name"
